          ...
          <table id="pasien" class="table table-striped">
            <thead>
                <tr>
                  ...
                  <th>Telepon</th>
                  <th>Alamat</th>
                  <th style="float: right; margin-right: 35px;">Opsi</th>
                </tr>
            </thead>
            <tbody>
        	<?php 
        		...
        		<tr>
                  ...
                  <td align="right">
              		<a href="<?=site_url('pasien/hapus/'.$result->kode_pasien)?>" class="btn btn-sm btn-danger hapus" style="font-family: semua;"><i class="fa fa-trash"></i></a>
              		<a href="<?=site_url('pasien/edit/'.$result->kode_pasien)?>" class="btn btn-sm btn-warning" style="font-family: semua;"><i class="fa fa-edit"></i></a>
                  </td>
                </tr>
        	<?php
        		}
