...
<section class="content">
	<div class="box">
        ...
        <div class="box-header">
          <h3 class="box-title" style="float: left; font-family: semua; font-size: 22px;">Data Stok Keluar</h3>
          <a href="<?=site_url('stok/keluar/tambah')?>" class="btn btn-sm btn-flat btn-primary" style="float: right;"><i class="fa fa-plus-circle"></i> Tambah</a>
          ...
          <table id="masuk" class="table table-striped ">
        	...
        	<?php 
        		...
        		<tr>
                  ...
                  <td><?=$result->nama?></td>
                  <td align="right">
              		<a href="<?=site_url('stok/keluar/hapus/'.$result->id.'/'.$result->kode_obat)?>" class="btn btn-sm btn-danger hapus" style="font-family: semua;"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
        	<?php
        		}
