...
<section class="content">
  ...
  <div class="box" style="padding-bottom: 30px;">
        <div class="box-header">
          <h3 class="box-title" style="float: left; font-family: semua;">Tambah Stok Masuk</h3>
          <a href="<?=site_url('stok/masuk')?>" class="btn btn-sm btn-flat btn-warning" style="float: right;"><i class="fa fa-chevron-left"></i> Kembali</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
        	<div class="col-md-4 col-md-offset-4">
        		<form action="<?=site_url('stok/proses')?>" method="post">
					...
					<div class="form-group">
					    ...
					    <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="stock baru / tambahan / dll" required>
					</div>
					<div class="form-group">
					    <label for="qty">Qty</label>
					    <input type="number" class="form-control" id="qty" name="qty" required>
					</div>
	              	<button type="submit" name="masuk" class="btn btn-sm btn-success"><i class="fa fa-paper-plane"></i> Simpan</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
	            <table id="masuk" class="table table-responsive" style="width: 100%;">
	                <thead>
	                    <tr>
